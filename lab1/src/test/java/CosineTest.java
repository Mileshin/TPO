...
public class CosineTest extends Assert {
    private HashMap<Double, Double> arrayTestValues = new java.util.HashMap<>();
    ...
    public void testCos() {
        ...
        for(Map.Entry entry : arrayTestValues.entrySet()) {
            ...
            actual = CosineTaylor.cos( ( (Double) entry.getValue() ).doubleValue());
            String message = "Equals: X = " + entry.getValue() + " Cos(X) = " + entry.getKey();
